...
const CallToAction = () => {
  return (
    ...
    <p className='text-gray-500 sm:text-sm'>Incididunt sint fugint pariature cupidatat consecteture sit cillum anim id veniam aliqua proident excepteteur commodo do ea.</p>
